...
✓ default.csv → projects/morseMachine/esp32dev/v1.1.1/partitions.csv


boot_app0.bin uit framework kopiëren...

✓ boot_app0.bin → projects/morseMachine/esp32dev/v1.1.1/boot_app0.bin
...
✓ bootloader.bin → projects/morseMachine/esp32dev/v1.1.1/bootloader.bin

✓ partitions.bin → projects/morseMachine/esp32dev/v1.1.1/partitions.bin
...
✓ firmware.bin → projects/morseMachine/esp32dev/v1.1.1/firmware.bin
...
✓ littlefs.bin toegevoegd aan flash.json met offset 0x290000

✓ flash.json aangemaakt: projects/morseMachine/esp32dev/v1.1.1/flash.json
...
✓ littlefs.bin → projects/morseMachine/esp32dev/v1.1.1/littlefs.bin
